<?php
  ...
  if(isset($_SESSION['login'])){
    ...
    // query
    $sql = "SELECT * FROM db_order ORDER BY id";
          ...
          <ul class="nav">
            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="tables">
                <ul class="nav flex-column sub-menu">
                  <li class="nav-item"> <a class="nav-link" href="#">Daftar Product</a></li>
                  ...
                  <div class="home-tab">
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                      <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" id="contact-tab" href="#" role="tab" aria-selected="false">Daftar Product</a>
                        </li>
                        <li class="nav-item">
                            ...
                            echo '<tbody>
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <a href="deleteBarang.php?id='.$row['id'].'">Hapus</a>
                                    </td>
                                  </tr>
                                </tbody>';
                          }
