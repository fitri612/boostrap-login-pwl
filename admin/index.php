        ...
        <div class="navbar-menu-wrapper d-flex align-items-top"> 
          <ul class="navbar-nav">
            <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
              ...
              ?>
              (<a href="barang.html">Cek Cart</a>) (<a href="logout.php">Logout</a>)        
            </li>
          </ul>
                ...
                <div class="home-tab">
                  <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                    <ul class="nav nav-tabs" role="tablist">
                      <li class="nav-item">
                        <a class="nav-link active ps-0" id="home-tab" href="#" role="tab" aria-controls="overview" aria-selected="true">Daftar Barang</a>
                      </li>
                      <li class="nav-item">
                          ...
                          while($row = $result->fetch_assoc()) {
                            ...
                            <div class="container-list">
                              <div class="list-produk">
                                  <img src="img/<?php echo $row['foto']?>" alt="aglonema">

                                  <p style="text-align: center;"><a href="AddCart.php?brg=<?php echo $row['nama']?>&hrg=<?php echo $row['hrg']?>&jml=1"><?php echo $row['nama']?></a></p>

                                  <h4><?php echo $row['hrg']?></h4>
                                </div>
                            </div>
                            <?php
                          }
